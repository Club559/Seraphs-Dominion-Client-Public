            ...
            if (this._L_1.length) {
                ...
                if (this._0G_x.bitmapFile) {
                    ...
                    if(this._0G_x.bitmapIndexMax != -1) {
                        _local12 = Math.floor(Math.random() * (this._0G_x.bitmapIndexMax - this._0G_x.bitmapIndex + 1)) + this._0G_x.bitmapIndex;
                    }
