...
package _E_7 {
    ...
    public class EquipmentToolTip extends _for_ {
        ...
        public function EquipmentToolTip(_arg1:int, _arg2:Player, _arg3:int, _arg4:String, _arg5:uint = 1, _arg6:Boolean = false, _arg7:Object = null) {
            ...
            var _local7:uint = ((((this._0G_J_ && this.meetsLevel) || ((this.player_ == null)))) ? 0x500C00 : 5578255);
        ...
        private function addLine(_arg1:int, _arg2:int):void {
            switch (_arg2) {
                case 0:
                    this.line_ = new _return((_be - 12), 0x310800);
                    this.line_.x = 8;
                    this.line_.y = _arg1;
                    addChild(this.line_);
                    return;
                ...
                case 2:
                    ...
                    return;
                case 3:
                    this.line3_ = new _return((_be - 12), 0x310800);
                    this.line3_.x = 8;
                    this.line3_.y = _arg1;
