...
public class Stats extends Sprite {
    ...
    public function draw(_arg1:Player):void {
        this._086[_E_w].draw(_arg1.attack_, _arg1._05s, _arg1._X_2);
        this._086[_D_O_].draw(_arg1.defense_, _arg1._07f, _arg1._0B_S_);
        this._086[_yl].draw(_arg1.speed_, _arg1._065, _arg1._b8);
        this._086[_0F_W_].draw(_arg1.dexterity_, _arg1._cu, _arg1._07C_);
        this._086[_a].draw(_arg1.vitality_, _arg1._pP_, _arg1._N_s);
        this._086[_S_L_].draw(_arg1.wisdom_, _arg1._B_e, _arg1._05Q_);
    }
