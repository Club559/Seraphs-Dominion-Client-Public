...
public class _0B_X_ extends Sprite {
    ...
    public function selectItem(_arg1:ItemSelectStart):void {
        if (this._6K_ != null || this.itemSelect_ != null) {
            return;
        }
        this.itemSelect_ = new ItemSelect(this.gs_, _arg1);
        this.itemSelect_.y = 123;
        this.itemSelect_.addEventListener(Event.CANCEL, this._05I_);
    }
    ...
    public function draw():void {
        ...
        else if (this.itemSelect_ != null) {
            this._3S_.visible = false;
            _O_m._03d(this, this._02y);
            _O_m._03d(this, this._U_T_);
            _O_m._041(this, this.itemSelect_);
        } else {
            this._3S_.visible = false;
    ...
    private function _0L_A_():void {
        ...
        if (this.itemSelect_ != null) {
            this.itemSelect_.removeEventListener(Event.CANCEL, this._05I_);
            _O_m._03d(this, this.itemSelect_);
