    ...
    public class MarketplaceSlot extends Sprite {
        ...
        public function redraw() {
            ...
            if(this.item_ != -1) {
                ...
                var _local4:BitmapData = ObjectLibrary.getRedrawnTextureFromType(this.item_, 80, true, true, _local3);
                if(this.data_ != null && this.data_.hasOwnProperty("TextureFile") && this.data_.TextureFile != "") {
                    _local4 = ObjectLibrary.getRedrawnTextureFromTypeCustom(this.item_, 80, true, this.item_, true, _local3);
                }
