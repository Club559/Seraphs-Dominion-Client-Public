...
public class _u5 extends Sprite {
    ...
    private static var soul_:BitmapData = null;
    ...
    public static function soul():BitmapData {
        if (soul_ == null) {
            soul_ = TextureRedrawer.resize(AssetLibrary._xK_("lofiObj3", 239), null, 40, true, 0, 0);
            soul_ = TextureRedrawer.outlineGlow(soul_, 0, 0xFFFFFFFF);
        }
        return (soul_);
    }
