...
public class _1f {
        ...
        for each (_local4 in _arg2) {
            ...
            switch (_local4._0F_4) {
                ...
                case StatData.TEAM_STAT:
                    ...
                    break;
                case StatData.SOULS:
                    (_arg1 as Player).setSouls(_local8);
                    break;
    ...
    private function _ee(_arg1:_G_f):void {
        var _local2:_qO_ = new _qO_(((("Client version: " + Parameters.clientVersion) + "\nServer version: ") + _arg1.errorDescription_ + "\n\nFind the latest client on the <font color='#7777EE'><a href='http://forum.kithio.com/seraphs-dominion/seraphs-dominion-news-and-information/update-and-build-notes/'>Forums</a></font>"), "Client Update Needed", "Ok", null, "/clientUpdate");
        _local2.addEventListener(_qO_.BUTTON1_EVENT, this._Y_h);
        this.gs_.stage.addChild(_local2);
        this._P_A_ = false;
    }
