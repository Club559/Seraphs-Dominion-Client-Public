...
public class __for extends _cM_ {
    ...
    private function _04P_():void {
        ...
        if (((Parameters.isTesting) && ((this._eJ_._T_1.servers_.length == 0)))) {
            if (Parameters._I_O_()) {
                _local1 = new _qO_(((("There are currently no testing servers available.  " + 'Please play on <font color="#7777EE">') + '<a href="http://realm.kithio.com/">') + "realm.kithio.com</a></font>."), "No Testing Servers", null, null, "/noTestingServers");
            } else {
                _local1 = new _qO_((((("The Seraphs' Dominion is currently offline.\n\n" + "Go here for more information:\n") + '<font color="#7777EE">') + '<a href="http://forum.kithio.com/">') + "forum.kithio.com</a></font>."), "The Angelics are Sleeping", null, null, "/offLine");
            }
    ...
    private function _uz():void {
        navigateToURL(new URLRequest("http://forum.kithio.com/"), "_blank");
    }
